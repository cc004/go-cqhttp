...
var remoteVersions = map[int]string{
	1: "https://raw.githubusercontent.com/MrXiaoM/qsign/mirai/txlib/8.9.88/android_phone.json",
	6: "https://raw.githubusercontent.com/MrXiaoM/qsign/mirai/txlib/8.9.88/android_pad.json",
}
